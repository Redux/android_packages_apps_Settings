...
public class InterfaceSettings extends PreferenceActivity implements
	...
	private static final String BATTERY_TOGGLE = "battery_icon_style";
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		mBatteryToggle = (ListPreference)findPreference(BATTERY_TOGGLE);
		mBatteryToggle.setOnPreferenceChangeListener(this);
