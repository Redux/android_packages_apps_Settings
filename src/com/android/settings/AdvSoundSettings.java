...
public class AdvSoundSettings extends PreferenceActivity implements
	OnPreferenceChangeListener {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			setTitle(R.string.adv_sound_settings);
			addPreferencesFromResource(R.xml.adv_sound_settings);
